...
Route::post('/login/2fa', [AuthController::class, 'verify2fa'])->middleware('throttle:5,1');
...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::post('/settings/whatsapp', [AdminController::class, 'updateWhatsappSettings'])->name('admin.settings.whatsapp');
    Route::post('/change-password', [AdminController::class, 'updatePassword'])->name('admin.password.update');
    Route::get('/messages', [AdminController::class, 'messages'])->name('admin.messages');
    Route::get('/messages/{id}/reply', [AdminController::class, 'showReplyForm'])->name('admin.messages.reply');
    Route::post('/messages/{id}/reply', [AdminController::class, 'replyMessage'])->name('admin.messages.reply.send');
