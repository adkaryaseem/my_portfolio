...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        return view('admin.dashboard', compact('stats', 'settings', 'whatsappSettings'));
    }
    ...
    public function settings()
    {
        $settings = Setting::all();
        $whatsappSettings = \App\Models\WhatsappSetting::first();
        return view('admin.settings', compact('settings', 'whatsappSettings'));
    }

    public function updateSettings(Request $request)
    {
        $allowedKeys = [
            'site_title', 'site_description', 'contact_email', 'contact_phone', 'hero_name', 'hero_title', 'about_subtitle', 'about_me',
    ...
    public function updateWhatsappSettings(Request $request)
    {
        $validated = $request->validate([
            ...
            'phone_number' => 'required|regex:/^[0-9]+$/|min:7|max:15',
        ...
        return back()->with('success', 'WhatsApp 2FA configuration updated successfully!');
    }
}
